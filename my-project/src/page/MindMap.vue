<template>
  <div id="container" style="height: 90vh; width: 90vw"></div>
</template>
    ...
    G6.registerBehavior('dice-mindmap', {
      ...
      clickNode(evt) {
        ...
        switch (name) {
          case 'add':
          {
            ...
            evt.currentTarget.updateItem(evt.item, {
              children: (model.children || []).concat([{
                ...
                color: model.color || this.colorArr[Math.floor(Math.random() * this.colorArr.length)],
              }, ]),
            });
          ...
          case 'delete':
          {
            let parent = evt.item.get('parent');
